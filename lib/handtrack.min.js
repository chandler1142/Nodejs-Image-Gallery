(function (global, factory) {
  ...
  (global = global || self, factory(global.handTrack = {}));
  ...
  class ObjectDetection {
    ...
    async detect(input) {
      ...
      const batched = tidy(() => {
        const imageTensor = fromPixels(input);
      ...
      let time0 = Date.now();
      console.log("batched cost: " + (time0-timeBegin));
      ...
      return this.model.executeAsync(batched).then(function (result) {
        ...
        let time1 = Date.now();
        console.log("calculate cost: " + (time1-time0));
        ...
        const indexTensor = tidy(() => {
          ...
          return image_ops.nonMaxSuppression(
            boxes2,
            scores,
        ...
        console.log("cost: " + (timeEnd-timeBegin));
